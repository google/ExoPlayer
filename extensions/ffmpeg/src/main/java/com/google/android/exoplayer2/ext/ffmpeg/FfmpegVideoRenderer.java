...
public final class FfmpegVideoRenderer extends DecoderVideoRenderer {
  ...
  private static final int DEFAULT_NUM_OF_INPUT_BUFFERS = 2;
  private static final int DEFAULT_NUM_OF_OUTPUT_BUFFERS = 1;
  ...
  @Override
  public final @C.FormatSupport int supportsFormat(Format format) {
  ...
  protected Decoder<DecoderInputBuffer, VideoDecoderOutputBuffer, FfmpegDecoderException>
    ...
    FfmpegVideoDecoder decoder =
        new FfmpegVideoDecoder(numInputBuffers, numOutputBuffers, initialInputBufferSize, threads,
            format);
