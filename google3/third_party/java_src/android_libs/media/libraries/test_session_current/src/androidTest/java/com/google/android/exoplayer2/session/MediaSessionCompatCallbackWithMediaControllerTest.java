...
public class MediaSessionCompatCallbackWithMediaControllerTest {
  ...
  private RemoteMediaController createControllerAndWaitConnection() throws Exception {
    ...
    AtomicReference<SessionToken> sessionToken2 = new AtomicReference<>();
  ...
  public void addMediaItems() throws Exception {
    int size = 2;
    List<MediaItem> testList = MediaTestUtils.createConvergedMediaItems(size);
  ...
  public void removeMediaItems() throws Exception {
    List<MediaItem> testList = MediaTestUtils.createConvergedMediaItems(/* size= */ 4);
    int fromIndex = 1;
    int toIndex = 3;
