...
public class DashManifestParserTest {
  ...
  private static final String SAMPLE_ASSET_IDENTIFIER = "mpd/sample_mpd_asset_identifier";
  ...
  public void parsePeriodAssetIdentifier() throws IOException {
    DashManifestParser parser = new DashManifestParser();
    DashManifest mpd = parser.parse(
        Uri.parse("https://example.com/test.mpd"),
        TestUtil
            .getInputStream(ApplicationProvider.getApplicationContext(), SAMPLE_ASSET_IDENTIFIER));
