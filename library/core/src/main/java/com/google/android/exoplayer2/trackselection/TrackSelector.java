 ...
 *       TODO: add link to track selector
 *   <li>When the player needs to make a track selection it will call . This typically occurs at the start
 ...
 *TODO: add link to track selector
 *
 * The {@link TrackSelectorResult} returned by  contains not only {@link TrackSelection}s for each renderer, but also {@link
...
public abstract class TrackSelector {
   ...
   * @param periodId The {@link MediaSource.MediaPeriodId} of the period for which tracks are to be selected.
