...
public abstract class SegmentBase {
  ...
  public static class SingleSegmentBase extends SegmentBase {
    ...
    /**
     * A {@code List} of uris of the segment.
     */
     ...
     * @param presentationTimeOffset The presentation time offset. The value in seconds is the
     *     division of this value and {@code timescale}.
     * @param uris A List of uris of the segment.
    ...
    public SingleSegmentBase(RangedUri initialization, long timescale, long presentationTimeOffset,
        List<String> uris, long indexStart, long indexLength) {
    ...
    /**
     * @param uri A {code List} of uris of the segment.
     */
    public SingleSegmentBase(List<String> uri) {
      this(null, 1, 0, uri, 0, -1);
    }

    public RangedUri getIndex() {
      return indexLength <= 0 ? null : new RangedUri(uris, null, indexStart, indexLength);
    }
  ...
  public static class SegmentTemplate extends MultiSegmentBase {
     ...
     * @param baseUrls A {@code List} of urls to use as the base for relative urls generated by the templates.
     */
    public SegmentTemplate(RangedUri initialization, long timescale, long presentationTimeOffset,
        int startNumber, long duration, List<SegmentTimelineElement> segmentTimeline,
        UrlTemplate initializationTemplate, UrlTemplate mediaTemplate, List<String> baseUrls) {
    ...
    public RangedUri getInitialization(Representation representation) {
      if (initializationTemplate != null) {
        ...
        return new RangedUri(baseUrls, urlString, 0, -1);
      } else {
    ...
    public RangedUri getSegmentUrl(Representation representation, int sequenceNumber) {
      ...
      return new RangedUri(baseUrls, uriString, 0, -1);
    }
