...
/** Tests for {@link ExoPlayerLibraryInfo}. */
@RunWith(AndroidJUnit4.class)
public class ExoPlayerLibraryInfoTest {
  ...
  public void versionAndSlashyAreConsistent() {
    assertThat(ExoPlayerLibraryInfo.VERSION_SLASHY)
        .isEqualTo("AndroidXMedia3/" + ExoPlayerLibraryInfo.VERSION);
  }
  ...
  public void versionIntIsSelfConsistentAndConsistentWithVersionString() {
    ...
    assertThat(ExoPlayerLibraryInfo.VERSION).matches(VERSION_PATTERN);
    Matcher matcher = VERSION_PATTERN.matcher(ExoPlayerLibraryInfo.VERSION);
    ...
    expect
        .withMessage("VERSION_INT for " + ExoPlayerLibraryInfo.VERSION)
        .that(ExoPlayerLibraryInfo.VERSION_INT)
