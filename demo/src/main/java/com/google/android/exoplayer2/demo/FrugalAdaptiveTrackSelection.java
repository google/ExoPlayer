 ...
 */
public class FrugalAdaptiveTrackSelection extends BaseTrackSelection {

    /**
     * Factory for {@link FrugalAdaptiveTrackSelection} instances.
     */
    public static final class Factory implements TrackSelection.Factory {
        ...
        @Override
        public FrugalAdaptiveTrackSelection createTrackSelection(TrackGroup group, int... tracks) {
            return new FrugalAdaptiveTrackSelection(group, tracks, bandwidthMeter, maxInitialBitrate,
     ...
     * @param bandwidthMeter Provides an estimate of the currently available bandwidth.
     */
    public FrugalAdaptiveTrackSelection(TrackGroup group, int[] tracks,
     ...
     *     for inaccuracies in the bandwidth estimator.
     */
    public FrugalAdaptiveTrackSelection(TrackGroup group, int[] tracks, BandwidthMeter bandwidthMeter,
    ...
    private int determineIdealSelectedIndex(long nowMs) {
        Log.d("FATS", "inside method");
        long bitrateEstimate = bandwidthMeter.getBitrateEstimate();
        Log.d("FATS Bitrate Estimate" , " "+bitrateEstimate);
        long effectiveBitrate = bitrateEstimate == BandwidthMeter.NO_ESTIMATE
                ? maxInitialBitrate : (long) (bitrateEstimate * bandwidthFraction) < 520929 ? (long) (bitrateEstimate * bandwidthFraction) : 520929;
        Log.d("FATS", " " + bandwidthFraction);
        Log.d("FATS Effective Bitrate" , " "+effectiveBitrate);
        int lowestBitrateNonBlacklistedIndex = 0;
        Log.d("FATS length" , " "+length);
        for (int i = 0; i < length; i++) {
            if (nowMs == Long.MIN_VALUE || !isBlacklisted(i, nowMs)) {
                Format format = getFormat(i);
                Log.d("FATS" , " "+format.bitrate);
                if (format.bitrate <= effectiveBitrate) {
                    Log.d("FATS line 255", " "+i);
                    return i;
                } else {
        ...
        Log.d("FATS line 257", " "+lowestBitrateNonBlacklistedIndex);
