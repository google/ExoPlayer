...
import com.google.android.exoplayer2.demo.databinding.SampleChooserActivityBinding;
...
public class SampleChooserActivity extends Activity {
    ...
    private SampleChooserActivityBinding binding;

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = DataBindingUtil.setContentView(this, R.layout.sample_chooser_activity);
    ...
    private void onSampleGroups(final List<SampleGroup> groups, boolean sawError) {
        ...
        binding.sampleList.setAdapter(new SampleAdapter(this, groups));
        binding.sampleList.setOnChildClickListener(new OnChildClickListener() {
            @Override
