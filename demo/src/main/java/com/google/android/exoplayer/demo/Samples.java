...
class Samples {
    ...
    public static class Sample {
        ...
        public Sample(String name, String uri, int type,String cover) {
            this(name, name.toLowerCase(Locale.US).replaceAll("\\s", ""), "", uri, type,cover);
        }

        public Sample(String name, String contentId, String provider, String uri, int type,String  cover) {
            this.name = name;
            ...
            this.uri = uri;
            this.type = type;
            Log.e("adding",this.name+" "+this.albumcover);
        }
    ...
    public static final Sample[] YOUTUBE_DASH_MP4 = new Sample[]{
            new Sample("Google Glass (MP4,H264)",
                    "http://www.youtube.com/api/manifest/dash/id/bf5bb2419360daf1/source/youtube?"
                            ...
                            + "8506521BFC350652163895D4C26DEE124209AA9E&key=ik0", PlayerActivity.TYPE_DASH,null ),
            new Sample("Google Play (MP4,H264)",
                    "http://www.youtube.com/api/manifest/dash/id/3aa39fa2cc27967f/source/youtube?"
                            ...
                            + "84308FF04844498CE6FBCE4731507882B8307798&key=ik0", PlayerActivity.TYPE_DASH,null),
    };
    ...
    public static final Sample[] YOUTUBE_DASH_WEBM = new Sample[]{
            new Sample("Google Glass (WebM,VP9)",
                    "http://www.youtube.com/api/manifest/dash/id/bf5bb2419360daf1/source/youtube?"
                            ...
                            + "7B9F0EC0505E1566E59B8E488E9419F253DDF413&key=ik0", PlayerActivity.TYPE_DASH,null),
            new Sample("Google Play (WebM,VP9)",
                    "http://www.youtube.com/api/manifest/dash/id/3aa39fa2cc27967f/source/youtube?"
                            + "as=fmp4_audio_clear,webm2_sd_hd_clear&sparams=ip,ipbits,expire,source,id,as&ip=0.0.0.0&"
                            + "ipbits=0&expire=19000000000&signature=B1C2A74783AC1CC4865EB312D7DD2D48230CC9FD."
                            + "BD153B9882175F1F94BFE5141A5482313EA38E8D&key=ik0", PlayerActivity.TYPE_DASH,null),
    };
    ...
    public static final Sample[] WIDEVINE_GTS = new Sample[]{
            new Sample("WV: HDCP not specified", "d286538032258a1c", "widevine_test",
                    WIDEVINE_GTS_MPD, PlayerActivity.TYPE_DASH,null),
    ...
    public static final Sample[] HLS = new Sample[]{
            ...
            new Sample("Apple ID3 metadata", "http://devimages.apple.com/samplecode/adDemo/ad.m3u8",
                    PlayerActivity.TYPE_HLS,null),
    };

    public static final Sample[] MISC = new Sample[]{
            new Sample("Dizzy", "http://html5demos.com/assets/dizzy.mp4", PlayerActivity.TYPE_OTHER,null),
            new Sample("Apple AAC 10s", "https://devimages.apple.com.edgekey.net/"
                    + "streaming/examples/bipbop_4x3/gear0/fileSequence0.aac", PlayerActivity.TYPE_OTHER,null),
            new Sample("Apple TS 10s", "https://devimages.apple.com.edgekey.net/streaming/examples/"
                    + "bipbop_4x3/gear1/fileSequence0.ts", PlayerActivity.TYPE_OTHER,null),
            new Sample("Android screens (Matroska)", "http://storage.googleapis.com/exoplayer-test-media-1/"
                    ...
                    PlayerActivity.TYPE_OTHER,null),
            new Sample("Big Buck Bunny (MP4 Video)",
                    "http://redirector.c.youtube.com/videoplayback?id=604ed5ce52eda7ee&itag=22&source=youtube&"
                            ...
                            + "&key=ik0", PlayerActivity.TYPE_OTHER,null),
            new Sample("Google Play (MP3 Audio)",
                    "http://storage.googleapis.com/exoplayer-test-media-0/play.mp3", PlayerActivity.TYPE_OTHER,null),
            new Sample("Google Glass (WebM Video with Vorbis Audio)",
                    "http://demos.webmproject.org/exoplayer/glass_vp9_vorbis.webm", PlayerActivity.TYPE_OTHER,null),
            new Sample("Big Buck Bunny (FLV Video)",
                    "http://vod.leasewebcdn.com/bbb.flv?ri=1024&rs=150&start=0", PlayerActivity.TYPE_OTHER,null),
    };


    public static final Sample[] LOCAL_VIDEOS = new Sample[]{
            new Sample("Some User friendly name of video 1",
                    "content://media/external/video/media/24272", PlayerActivity.TYPE_OTHER,null),
            new Sample("Some User friendly name of video 2",
                    "/mnt/sdcard/VID_20151129_185956.mp4", PlayerActivity.TYPE_OTHER,null),
    };
