...
/* package */ class Samples {
    ...
    public static final Sample[] UHD = new Sample[]{
            // http://www.elementaltechnologies.com/resources/4k-test-sequences
            new Sample("Foreman 4K (compressed mp4)",
                    "http://hwcdn.net/j9t9v3v5/cds/Foreman_H264.mp4",
                    PlayerActivity.TYPE_OTHER),
            new Sample("Mobile 4K (compressed mp4)","http://hwcdn.net/j9t9v3v5/cds/Mobile_H264.mp4",
                    PlayerActivity.TYPE_OTHER),
            new Sample("Suzie 4K (compressed mp4)","http://hwcdn.net/j9t9v3v5/cds/Suzie_H264.mp4",
                    PlayerActivity.TYPE_OTHER),
            new Sample("Cactus 4K (compressed mp4)","http://hwcdn.net/j9t9v3v5/cds/Cactus_H264.mp4",
                    PlayerActivity.TYPE_OTHER),
            new Sample("Coast Guard 4K (compressed mp4)",
    ...
    public static final Sample[] SMOOTHSTREAMING = new Sample[]{
            new Sample("WV: HDCP not specified", "d286538032258a1c",
                    "http://www.youtube.com/api/manifest/dash/id/d286538032258a1c/source/youtube?"
                            ...
                            + "8971631EB657BC33EC2F48A2FF4211956760C3E9&key=ik0", PlayerActivity.TYPE_SS),
