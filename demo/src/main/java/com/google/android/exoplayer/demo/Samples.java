...
/* package */ class Samples {
    ...
    public static final Sample[] HLS = new Sample[] {
            ...
            new Sample("IFRAME TEST 2",
                    "https://us-west.lts2.seagate.com/lyvecamtest/HLS-example-streams/iframe_index2.m3u8", PlayerActivity.TYPE_HLS),
            new Sample("IFRAME TEST 3",
                    "https://devimages.apple.com.edgekey.net/streaming/examples/bipbop_16x9/gear1/iframe_index.m3u8", PlayerActivity.TYPE_HLS),
            new Sample("Apple master playlist",
                    "http://85.17.93.5/als/Apple_Advanced/gear1/iframe_index.m3u8", PlayerActivity.TYPE_HLS),
            new Sample("Apple master playlist",
