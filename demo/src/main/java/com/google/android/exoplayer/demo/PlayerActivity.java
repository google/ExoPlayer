...
public class PlayerActivity extends Activity implements SurfaceHolder.Callback, View.OnClickListener,
    ...
    public static final String CONTENT_TYPE_ALBUMCOVER = "content_albumcover";
    ...
    public void onResume() {
        ...
        Log.e("album cover is : ", intent.getStringExtra(CONTENT_TYPE_ALBUMCOVER) + " ");
        if (intent.getStringExtra(CONTENT_TYPE_ALBUMCOVER) == null) {
