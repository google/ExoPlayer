...
public final class Cea708Parser implements SubtitleParser {
  ...
  public Cea708Parser(int accessibilityChannel, @Nullable List<byte[]> initializationData) {
  ...
  // Cea608Parser.CueBuilder which could be refactored into a separate class.
